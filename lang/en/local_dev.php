...
$string['gitauthors'] = 'Git authorss';
$string['gitauthorsby'] = 'Git authors in Moodle {$a->version} by {$a->author} <{$a->email}>';
$string['gitcommits'] = 'Git commits';
$string['gitcommitsby'] = 'Git commits in Moodle {$a->version} for {$a->author} <{$a->email}>';
$string['gitmerges'] = 'Git merges';
$string['gitmergesby'] = 'Git merges in Moodle {$a->version} by {$a->author} <{$a->email}>';
